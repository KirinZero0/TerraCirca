...
@section('content')
    <x-content>
        <x-slot name="modul">
            @include('admin.partials.back-with-title', ['title' => 'Edit Kategori Produk'])
        </x-slot>
        <div>
            <form action="{{ route('admin.product.product_category.update', $productCategory->id) }}" enctype="multipart/form-data" method="post"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" name="name" value="{{ old('name', $productCategory->name) }}" required>
