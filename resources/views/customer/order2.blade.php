            ...
            <div class="container mx-auto mt-5 px-4">
                <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-md mb-3 border-b-4 border-[#4693B1] relative">
                        ...
                        <form action="{{ route('customer.add.order') }}" enctype="multipart/form-data" method="post" novalidate
                        ...
                        <button type="submit"
                            class="bg-[#4693B1] text-white p-1 w-[3rem] h-[3rem] rounded-full hover:bg-blue-600 absolute bottom-[-1.5rem] right-[-1.5rem]">
